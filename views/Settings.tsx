          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">
                Enable mock data to test the UI without making real API calls. Useful if APIs are
                blocked.
              </p>
            </div>
            <div className="flex items-center">
              ...
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${localSettings.demoMode ? 'translate-x-6' : 'translate-x-1'}`}
                />
              </button>
            </div>
          </div>
